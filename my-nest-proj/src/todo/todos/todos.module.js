...
let TodosModule = exports.TodosModule = (() => {
    ...
    let _classThis;
    var TodosModule = _classThis = class {
    };
    __setFunctionName(_classThis, "TodosModule");
    (() => {
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name }, null, _classExtraInitializers);
        TodosModule = _classThis = _classDescriptor.value;
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TodosModule = _classThis;
})();
